...
public class Stage3SecondaryA extends Brain {
  ...
  public void step() {
    ...
    if (state==TURNSOUTHTASK && !(isSameDirection(myGetHeading(),Parameters.SOUTH))) {
      ...
      sendLogMessage(String.valueOf(state==TURNSOUTHTASK && !(isSameDirection(myGetHeading(),Parameters.SOUTH))));
      System.err.println(String.valueOf(state==TURNSOUTHTASK && !(isSameDirection(myGetHeading(),Parameters.SOUTH))));
